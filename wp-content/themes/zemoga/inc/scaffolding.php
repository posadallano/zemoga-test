 ...
 */
function zemoga_display_scaffolding_section( $args = array() ) {
	...
	$allowed_tags = zemoga_scaffolding_allowed_html();
	...
	<div class="scaffolding-document <?php echo esc_attr( $class ); ?>">
		...
		<header class="scaffolding-document-header display-flex flex-start space-between">
			...
			<button type="button" class="scaffolding-button"><?php esc_html_e( 'Details', 'zemoga' ); ?></button>
		...
		<div class="scaffolding-document-content">
			...
			<?php if ( $args['description'] ) : ?>
				<p><strong><?php esc_html_e( 'Description', 'zemoga' ); ?>:</strong></p>
				<p class="scaffolding-document-description"><?php echo esc_html( $args['description'] ); ?></p>
			<?php endif; ?>

			<?php if ( $args['parameters'] ) : ?>
				<p><strong><?php esc_html_e( 'Parameters', 'zemoga' ); ?>:</strong></p>
			...
			<?php if ( $args['arguments'] ) : ?>
				<p><strong><?php esc_html_e( 'Arguments', 'zemoga' ); ?>:</strong></p>
			...
			<?php if ( $args['usage'] ) : ?>
				<p><strong><?php esc_html_e( 'Usage', 'zemoga' ); ?>:</strong></p>
				<pre><?php echo esc_html( $args['usage'] ); ?></pre>
			<?php endif; ?>

			<?php if ( $args['output'] ) : ?>
				<p><strong><?php esc_html_e( 'HTML Output', 'zemoga' ); ?>:</strong></p>
 ...
 * @author Carrie Forde
 */
function zemoga_scaffolding_allowed_html() {
 ...
 * @author Carrie Forde
 */
function zemoga_display_global_scaffolding_section( $args = array() ) {
 ...
 * @author Carrie Forde
 */
function zemoga_hook_theme_scaffolding() {
...
add_action( 'zemoga_scaffolding_content', 'zemoga_hook_theme_scaffolding' );
