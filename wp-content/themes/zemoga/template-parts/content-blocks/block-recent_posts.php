...
if ( $categories || $tags ) {
	$args = zemoga_get_recent_posts_query_arguments( $categories, $tags );
}
...
$recent_posts = zemoga_get_recent_posts( $args );
		...
		<div class="container display-flex <?php echo esc_attr( $animation_class ); ?>">
			...
			while ( $recent_posts->have_posts() ) :
				...
				zemoga_display_card(
					array(
						'title' => get_the_title(),
						'image' => zemoga_get_post_image_url( 'medium' ),
						'text'  => zemoga_get_the_excerpt( array(
							'length' => 20,
							'more'   => '...',
						) ),
