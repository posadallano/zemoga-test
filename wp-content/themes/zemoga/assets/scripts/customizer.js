...
( function( window, $, app ) {
	...
	app.cache = function() {
		app.$c = {
			window: $( window ),
			headerButtonSelect: $( '#customize-control-zemoga_header_button select' ),
			headerLinkButton: $( '#customize-control-zemoga_header_button_url' ),
			headerLinkText: $( '#customize-control-zemoga_header_button_text' )
		};
	};
